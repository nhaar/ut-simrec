...
int Simulator::fix_step_total(int calculated_steps, int* downtime_steps) {
    ...
    if (steps <= downtime_steps[0]) return downtime_steps[0];
    ...
    else return steps + downtime_steps[1];
}